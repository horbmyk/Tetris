...
public class Element_four_State__1 : StateBlockTetris
{
    public Element_four_State__1(Cell c_0, Cell c_1, Cell c_2, Cell c_3)
    {
        cells = new Cell[4];
        cells[0] = c_0;
        cells[1] = c_1;
    ...
    && CommonData.CommonArr[cells[3].X, cells[3].Y - 1] == 0)
        {
            ...
            Element_four_State__2 element_four_State__2 = new Element_four_State__2(c_0, c_1, c_2, c_3);
            bc.stateBlockTetris = element_four_State__2;
        }
...
public class Element_four_State__2 : StateBlockTetris
{
    public Element_four_State__2(Cell c_0, Cell c_1, Cell c_2, Cell c_3)
    {
        cells = new Cell[4];
        cells[0] = c_0;
        cells[1] = c_1;
    ...
    && CommonData.CommonArr[cells[3].X + 1, cells[3].Y] == 0)
        {
            ...
            Cell c_2 = new Cell(cells[2].X, cells[2].Y, 4);
            Cell c_3 = new Cell(cells[3].X, cells[3].Y, 4);
            Element_four_State__3 element_four_State__3 = new Element_four_State__3(c_0, c_1, c_2, c_3);
            bc.stateBlockTetris = element_four_State__3;
        }
...
public class Element_four_State__3 : StateBlockTetris
{
    public Element_four_State__3(Cell c_0, Cell c_1, Cell c_2, Cell c_3)
    {
        cells = new Cell[4];
        cells[0] = c_0;
        cells[1] = c_1;
    ...
    public override void Rotate(BlockController bc)
    {
            ...
            && CommonData.CommonArr[cells[3].X, cells[3].Y + 1] == 0)
        {
            ...
            Cell c_2 = new Cell(cells[2].X, cells[2].Y, 4);
            Cell c_3 = new Cell(cells[3].X, cells[3].Y, 4);
            Element_four_State__4 element_four_State__4 = new Element_four_State__4(c_0, c_1, c_2, c_3);
            bc.stateBlockTetris = element_four_State__4;
...
public class Element_four_State__4 : StateBlockTetris
{
    public Element_four_State__4(Cell c_0, Cell c_1, Cell c_2, Cell c_3)
    {
        cells = new Cell[4];
        cells[0] = c_0;
        cells[1] = c_1;
