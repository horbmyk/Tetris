...
using UnityEngine;
public class Element_three_State__1 : StateBlockTetris
{
    public Element_three_State__1(Cell c_0, Cell c_1, Cell c_2, Cell c_3)
    {
        cells = new Cell[4];
        cells[0] = c_0;
        cells[1] = c_1;
    ...
    && CommonData.CommonArr[cells[2].X - 2, cells[2].Y] == 0)
        {
            ...
            CommonData.CommonArr[cells[3].X, cells[3].Y + 1] = CommonData.CommonArr[cells[2].X, cells[2].Y];
            ...
            Cell c_0 = new Cell(cells[0].X, cells[0].Y, 3);
            Cell c_1 = new Cell(cells[1].X, cells[1].Y, 3);
            Cell c_2 = new Cell(cells[2].X, cells[2].Y, 3);
            Cell c_3 = new Cell(cells[3].X, cells[3].Y, 3);
            Element_three_State__2 element_three_State__2 = new Element_three_State__2(c_0, c_1, c_2, c_3);
            bc.stateBlockTetris = element_three_State__2;

        }



        if (CommonData.CommonArr[cells[3].X, cells[3].Y + 1] == 0
            && CommonData.CommonArr[cells[3].X, cells[3].Y - 1] == 0
            && CommonData.CommonArr[cells[0].X + 1, cells[0].Y] == 0
            && CommonData.CommonArr[cells[1].X + 1, cells[1].Y] == 0
            && CommonData.CommonArr[cells[2].X + 1, cells[2].Y] == 0)
...
public class Element_three_State__2 : StateBlockTetris
{
    public Element_three_State__2(Cell c_0, Cell c_1, Cell c_2, Cell c_3)
    {
        cells = new Cell[4];
        cells[0] = c_0;
        cells[1] = c_1;
    ...
    && CommonData.CommonArr[cells[3].X + 1, cells[3].Y] == 0)
        {
            ...
            Cell c_2 = new Cell(cells[2].X, cells[2].Y, 3);
            Cell c_3 = new Cell(cells[3].X, cells[3].Y, 3);
            Element_three_State__3 element_three_State__3 = new Element_three_State__3(c_0, c_1, c_2, c_3);
            bc.stateBlockTetris = element_three_State__3;
        }
...
public class Element_three_State__3 : StateBlockTetris
{
    public Element_three_State__3(Cell c_0, Cell c_1, Cell c_2, Cell c_3)
    {
        cells = new Cell[4];
        cells[0] = c_0;
        cells[1] = c_1;
    ...
    && CommonData.CommonArr[cells[3].X, cells[3].Y - 1] == 0)
        {
            CommonData.CommonArr[cells[3].X, cells[3].Y - 1] = CommonData.CommonArr[cells[3].X, cells[3].Y];
            CommonData.CommonArr[cells[3].X, cells[3].Y] = 0;
            ...
            Cell c_2 = new Cell(cells[2].X, cells[2].Y, 3);
            Cell c_3 = new Cell(cells[3].X, cells[3].Y, 3);
            Element_three_State__4 element_three_State__4 = new Element_three_State__4(c_0, c_1, c_2, c_3);
            bc.stateBlockTetris = element_three_State__4;
...
public class Element_three_State__4 : StateBlockTetris
{
    public Element_three_State__4(Cell c_0, Cell c_1, Cell c_2, Cell c_3)
    {
        cells = new Cell[4];
        cells[0] = c_0;
        cells[1] = c_1;
    ...
    && CommonData.CommonArr[cells[3].X + 1, cells[3].Y] == 0)
        {
            ...
            Cell c_2 = new Cell(cells[2].X, cells[2].Y, 3);
            Cell c_3 = new Cell(cells[3].X, cells[3].Y, 3);
            Element_three_State__1 element_three_State__1 = new Element_three_State__1(c_0, c_1, c_2, c_3);
            bc.stateBlockTetris = element_three_State__1;
        }

        if (cells[2].Y < CommonData.Lenght - 1
            && CommonData.CommonArr[cells[3].X - 1, cells[3].Y] == 0
            && CommonData.CommonArr[cells[3].X + 1, cells[3].Y] == 0
            && CommonData.CommonArr[cells[1].X, cells[1].Y + 1] == 0
            && CommonData.CommonArr[cells[2].X, cells[2].Y + 1] == 0)
